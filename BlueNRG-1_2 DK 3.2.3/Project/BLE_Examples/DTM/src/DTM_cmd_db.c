...
const hci_command_table_type hci_command_table[164] = {
  /* hci_disconnect */
...
{
  /* Input params */
  hci_le_set_advertise_enable_cp0 *cp0 = (hci_le_set_advertise_enable_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_set_limited_discoverable_cp0 *cp0 = (aci_gap_set_limited_discoverable_cp0 *)(buffer_in + (0));
  aci_gap_set_limited_discoverable_cp1 *cp1 = (aci_gap_set_limited_discoverable_cp1 *)(buffer_in + (0 + 1 + 2 + 2 + 1 + 1 + 1 + cp0->Local_Name_Length * (sizeof(uint8_t))));
  aci_gap_set_limited_discoverable_cp2 *cp2 = (aci_gap_set_limited_discoverable_cp2 *)(buffer_in + (0 + 1 + 2 + 2 + 1 + 1 + 1 + cp0->Local_Name_Length * (sizeof(uint8_t)) + 1 + cp1->Service_Uuid_length * (sizeof(uint8_t))));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 1 + 2 + 2 + 1 + 1 + 1 + cp0->Local_Name_Length * (sizeof(uint8_t)) + 1 + cp1->Service_Uuid_length * (sizeof(uint8_t)) + 2 + 2)
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gap_set_discoverable_cp0 *cp0 = (aci_gap_set_discoverable_cp0 *)(buffer_in + (0));
  aci_gap_set_discoverable_cp1 *cp1 = (aci_gap_set_discoverable_cp1 *)(buffer_in + (0 + 1 + 2 + 2 + 1 + 1 + 1 + cp0->Local_Name_Length * (sizeof(uint8_t))));
  aci_gap_set_discoverable_cp2 *cp2 = (aci_gap_set_discoverable_cp2 *)(buffer_in + (0 + 1 + 2 + 2 + 1 + 1 + 1 + cp0->Local_Name_Length * (sizeof(uint8_t)) + 1 + cp1->Service_Uuid_length * (sizeof(uint8_t))));
...
{
  /* Input params */
  aci_gap_set_direct_connectable_cp0 *cp0 = (aci_gap_set_direct_connectable_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 1 + 1 + 1 + 6 + 2 + 2)
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
uint16_t aci_gap_set_authentication_requirement_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 1 + 1 + 1 + 1 + 1 + 1 + 1 + 4 + 1)
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gap_set_authorization_requirement_cp0 *cp0 = (aci_gap_set_authorization_requirement_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_authorization_resp_cp0 *cp0 = (aci_gap_authorization_resp_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_set_non_connectable_cp0 *cp0 = (aci_gap_set_non_connectable_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_set_undirected_connectable_cp0 *cp0 = (aci_gap_set_undirected_connectable_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_update_adv_data_cp0 *cp0 = (aci_gap_update_adv_data_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 1 + cp0->AdvDataLen * (sizeof(uint8_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gap_delete_ad_type_cp0 *cp0 = (aci_gap_delete_ad_type_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_start_limited_discovery_proc_cp0 *cp0 = (aci_gap_start_limited_discovery_proc_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_start_general_discovery_proc_cp0 *cp0 = (aci_gap_start_general_discovery_proc_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gap_start_name_discovery_proc_cp0 *cp0 = (aci_gap_start_name_discovery_proc_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 1 + 6 + 1 + 2 + 2 + 2 + 2 + 2 + 2)
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
 ...
 */
/* Command len: 2 + 2 + 1 + 2 + 2 + 2 + 2 + 2 + 2 + 1 + cp0->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)) */
/* Response len: 1 */
uint16_t aci_gap_start_auto_connection_establish_proc_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_gap_start_auto_connection_establish_proc_cp0 *cp0 = (aci_gap_start_auto_connection_establish_proc_cp0 *)(buffer_in + (0));
  ...
  if(buffer_in_length != 2 + 2 + 1 + 2 + 2 + 2 + 2 + 2 + 2 + 1 + cp0->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
  ...
  *status = aci_gap_start_auto_connection_establish_proc(cp0->LE_Scan_Interval /* 2 */,
                                                         ...
                                                         Whitelist_Entry /* cp0->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)) */);
fail:
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0F;
  buffer_out[2] = output_size + 3;
...
{
  /* Input params */
  aci_gap_start_general_connection_establish_proc_cp0 *cp0 = (aci_gap_start_general_connection_establish_proc_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 1 + 2 + 2 + 1 + 1 + 1)
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
/* tBleStatus aci_gap_start_selective_connection_establish_proc(uint8_t LE_Scan_Type,
                                                             ...
                                                             Whitelist_Entry_t Whitelist_Entry[]);
 */
/* Command len: 1 + 2 + 2 + 1 + 1 + 1 + 1 + cp0->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)) */
/* Response len: 1 */
uint16_t aci_gap_start_selective_connection_establish_proc_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_gap_start_selective_connection_establish_proc_cp0 *cp0 = (aci_gap_start_selective_connection_establish_proc_cp0 *)(buffer_in + (0));
  Whitelist_Entry_t Whitelist_Entry[HCI_MAX_PAYLOAD_SIZE/sizeof(Whitelist_Entry_t)];
  ...
  if(buffer_in_length != 1 + 2 + 2 + 1 + 1 + 1 + 1 + cp0->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gap_terminate_gap_proc_cp0 *cp0 = (aci_gap_terminate_gap_proc_cp0 *)(buffer_in + (0));
...
/* tBleStatus aci_gap_set_broadcast_mode(uint16_t Advertising_Interval_Min,
                                      ...
                                      Whitelist_Entry_t Whitelist_Entry[]);
 */
/* Command len: 2 + 2 + 1 + 1 + 1 + cp0->Adv_Data_Length * (sizeof(uint8_t)) + 1 + cp1->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)) */
/* Response len: 1 */
uint16_t aci_gap_set_broadcast_mode_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_gap_set_broadcast_mode_cp0 *cp0 = (aci_gap_set_broadcast_mode_cp0 *)(buffer_in + (0));
  aci_gap_set_broadcast_mode_cp1 *cp1 = (aci_gap_set_broadcast_mode_cp1 *)(buffer_in + (0 + 2 + 2 + 1 + 1 + 1 + cp0->Adv_Data_Length * (sizeof(uint8_t))));
  Whitelist_Entry_t Whitelist_Entry[HCI_MAX_PAYLOAD_SIZE/sizeof(Whitelist_Entry_t)];
  ...
  if(buffer_in_length != 2 + 2 + 1 + 1 + 1 + cp0->Adv_Data_Length * (sizeof(uint8_t)) + 1 + cp1->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
  ...
  *status = aci_gap_set_broadcast_mode(cp0->Advertising_Interval_Min /* 2 */,
                                       ...
                                       Whitelist_Entry /* cp1->Num_of_Whitelist_Entries * (sizeof(packed_Whitelist_Entry_t)) */);
fail:
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
  buffer_out[2] = output_size + 3;
...
{
  /* Input params */
  aci_gap_start_observation_proc_cp0 *cp0 = (aci_gap_start_observation_proc_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 1 + 1 + 1 + 1)
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
/* tBleStatus aci_gap_add_devices_to_resolving_list(uint8_t Num_of_Resolving_list_Entries,
                                                 ...
                                                 uint8_t Clear_Resolving_List);
 */
/* Command len: 1 + cp0->Num_of_Resolving_list_Entries * (sizeof(packed_Whitelist_Identity_Entry_t)) + 1 */
/* Response len: 1 */
uint16_t aci_gap_add_devices_to_resolving_list_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_gap_add_devices_to_resolving_list_cp0 *cp0 = (aci_gap_add_devices_to_resolving_list_cp0 *)(buffer_in + (0));
  aci_gap_add_devices_to_resolving_list_cp1 *cp1 = (aci_gap_add_devices_to_resolving_list_cp1 *)(buffer_in + (0 + 1 + cp0->Num_of_Resolving_list_Entries * (sizeof(packed_Whitelist_Identity_Entry_t))));
  ...
  if(buffer_in_length != 1 + cp0->Num_of_Resolving_list_Entries * (sizeof(packed_Whitelist_Identity_Entry_t)) + 1)
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
  ...
  *status = aci_gap_add_devices_to_resolving_list(cp0->Num_of_Resolving_list_Entries /* 1 */,
                                                  Whitelist_Identity_Entry /* cp0->Num_of_Resolving_list_Entries * (sizeof(packed_Whitelist_Identity_Entry_t)) */,
...
{
  /* Input params */
  aci_gatt_add_service_cp0 *cp0 = (aci_gatt_add_service_cp0 *)(buffer_in + (0));
  aci_gatt_add_service_cp1 *cp1 = (aci_gatt_add_service_cp1 *)(buffer_in + (0 + 1 + (cp0->Service_UUID_Type == 1 ? 2 : (cp0->Service_UUID_Type == 2 ? 16 : 0))));
  Service_UUID_t Service_UUID;
...
{
  /* Input params */
  aci_gatt_include_service_cp0 *cp0 = (aci_gatt_include_service_cp0 *)(buffer_in + (0));
  Include_UUID_t Include_UUID;
  ...
  if(buffer_in_length != 2 + 2 + 2 + 1 + (cp0->Include_UUID_Type == 1 ? 2 : (cp0->Include_UUID_Type == 2 ? 16 : 0)))
  {
    rp0->Status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gatt_add_char_cp0 *cp0 = (aci_gatt_add_char_cp0 *)(buffer_in + (0));
  aci_gatt_add_char_cp1 *cp1 = (aci_gatt_add_char_cp1 *)(buffer_in + (0 + 2 + 1 + (cp0->Char_UUID_Type == 1 ? 2 : (cp0->Char_UUID_Type == 2 ? 16 : 0))));
  Char_UUID_t Char_UUID;
...
{
  /* Input params */
  aci_gatt_add_char_desc_cp0 *cp0 = (aci_gatt_add_char_desc_cp0 *)(buffer_in + (0));
  aci_gatt_add_char_desc_cp1 *cp1 = (aci_gatt_add_char_desc_cp1 *)(buffer_in + (0 + 2 + 2 + 1 + (cp0->Char_Desc_Uuid_Type == 1 ? 2 : (cp0->Char_Desc_Uuid_Type == 2 ? 16 : 0))));
  aci_gatt_add_char_desc_cp2 *cp2 = (aci_gatt_add_char_desc_cp2 *)(buffer_in + (0 + 2 + 2 + 1 + (cp0->Char_Desc_Uuid_Type == 1 ? 2 : (cp0->Char_Desc_Uuid_Type == 2 ? 16 : 0)) + 1 + 1 + cp1->Char_Desc_Value_Length * (sizeof(uint8_t))));
  Char_Desc_Uuid_t Char_Desc_Uuid;
  ...
  if(buffer_in_length != 2 + 2 + 1 + (cp0->Char_Desc_Uuid_Type == 1 ? 2 : (cp0->Char_Desc_Uuid_Type == 2 ? 16 : 0)) + 1 + 1 + cp1->Char_Desc_Value_Length * (sizeof(uint8_t)) + 1 + 1 + 1 + 1 + 1)
  {
    rp0->Status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gatt_update_char_value_cp0 *cp0 = (aci_gatt_update_char_value_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 1 + 1 + cp0->Char_Value_Length * (sizeof(uint8_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gatt_del_char_cp0 *cp0 = (aci_gatt_del_char_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_del_service_cp0 *cp0 = (aci_gatt_del_service_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_del_include_service_cp0 *cp0 = (aci_gatt_del_include_service_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_exchange_config_cp0 *cp0 = (aci_gatt_exchange_config_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_att_find_info_req_cp0 *cp0 = (aci_att_find_info_req_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_att_find_by_type_value_req_cp0 *cp0 = (aci_att_find_by_type_value_req_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 2 + 2 + 1 + cp0->Attribute_Val_Length * (sizeof(uint8_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_att_read_by_type_req_cp0 *cp0 = (aci_att_read_by_type_req_cp0 *)(buffer_in + (0));
  UUID_t UUID;
...
{
  /* Input params */
  aci_att_read_by_group_type_req_cp0 *cp0 = (aci_att_read_by_group_type_req_cp0 *)(buffer_in + (0));
  UUID_t UUID;
...
{
  /* Input params */
  aci_att_prepare_write_req_cp0 *cp0 = (aci_att_prepare_write_req_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 2 + 1 + cp0->Attribute_Val_Length * (sizeof(uint8_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_att_execute_write_req_cp0 *cp0 = (aci_att_execute_write_req_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_disc_all_primary_services_cp0 *cp0 = (aci_gatt_disc_all_primary_services_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_disc_primary_service_by_uuid_cp0 *cp0 = (aci_gatt_disc_primary_service_by_uuid_cp0 *)(buffer_in + (0));
  UUID_t UUID;
...
{
  /* Input params */
  aci_gatt_find_included_services_cp0 *cp0 = (aci_gatt_find_included_services_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_disc_all_char_of_service_cp0 *cp0 = (aci_gatt_disc_all_char_of_service_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_disc_char_by_uuid_cp0 *cp0 = (aci_gatt_disc_char_by_uuid_cp0 *)(buffer_in + (0));
  UUID_t UUID;
...
{
  /* Input params */
  aci_gatt_disc_all_char_desc_cp0 *cp0 = (aci_gatt_disc_all_char_desc_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_read_char_value_cp0 *cp0 = (aci_gatt_read_char_value_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_read_using_char_uuid_cp0 *cp0 = (aci_gatt_read_using_char_uuid_cp0 *)(buffer_in + (0));
  UUID_t UUID;
...
{
  /* Input params */
  aci_gatt_read_long_char_value_cp0 *cp0 = (aci_gatt_read_long_char_value_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_read_multiple_char_value_cp0 *cp0 = (aci_gatt_read_multiple_char_value_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_write_char_value_cp0 *cp0 = (aci_gatt_write_char_value_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 1 + cp0->Attribute_Val_Length * (sizeof(uint8_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gatt_write_long_char_value_cp0 *cp0 = (aci_gatt_write_long_char_value_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_write_char_reliable_cp0 *cp0 = (aci_gatt_write_char_reliable_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_write_long_char_desc_cp0 *cp0 = (aci_gatt_write_long_char_desc_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_read_long_char_desc_cp0 *cp0 = (aci_gatt_read_long_char_desc_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_write_char_desc_cp0 *cp0 = (aci_gatt_write_char_desc_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_read_char_desc_cp0 *cp0 = (aci_gatt_read_char_desc_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_write_without_resp_cp0 *cp0 = (aci_gatt_write_without_resp_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_signed_write_without_resp_cp0 *cp0 = (aci_gatt_signed_write_without_resp_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_confirm_indication_cp0 *cp0 = (aci_gatt_confirm_indication_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_write_resp_cp0 *cp0 = (aci_gatt_write_resp_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 1 + 1 + 1 + cp0->Attribute_Val_Length * (sizeof(uint8_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gatt_allow_read_cp0 *cp0 = (aci_gatt_allow_read_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_set_security_permission_cp0 *cp0 = (aci_gatt_set_security_permission_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_set_desc_value_cp0 *cp0 = (aci_gatt_set_desc_value_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  if(buffer_in_length != 2 + 2 + 2 + 2 + 1 + cp0->Char_Desc_Value_Length * (sizeof(uint8_t)))
  {
    *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
    goto fail;
  }
...
{
  /* Input params */
  aci_gatt_read_handle_value_cp0 *cp0 = (aci_gatt_read_handle_value_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_update_char_value_ext_cp0 *cp0 = (aci_gatt_update_char_value_ext_cp0 *)(buffer_in + (0));
  ...
  if (buffer_out_max_length < (1 + 6)) { return 0; }
  #if EN_512_ATT_MTU
	if(buffer_in_length != 2 + 2 + 2 + 1 + 2 + 2 +2/* 1*/ + cp0->Value_Length * (sizeof(uint8_t)))
	#else
	if(buffer_in_length != 2 + 2 + 2 + 1 + 2 + 2 + 1 + cp0->Value_Length * (sizeof(uint8_t)))
...
{
  /* Input params */
  aci_gatt_deny_read_cp0 *cp0 = (aci_gatt_deny_read_cp0 *)(buffer_in + (0));
...
{
  /* Input params */
  aci_gatt_set_access_permission_cp0 *cp0 = (aci_gatt_set_access_permission_cp0 *)(buffer_in + (0));
 ...
 *        error of the protocol stack. After this event is received, it is
 *        recommended to force a device reset.
 *        Values:
...
{
  uint8_t buffer_out[HCI_MAX_PAYLOAD_SIZE];
  ...
  /* Output params */
	#if (EN_512_ATT_MTU)
  aci_gatt_attribute_modified_event_rp0 *rp0 = (aci_gatt_attribute_modified_event_rp0 *) (buffer_out + 7);
	#else
	aci_gatt_attribute_modified_event_rp0 *rp0 = (aci_gatt_attribute_modified_event_rp0 *) (buffer_out + 5);
	#endif //#if (EN_512_ATT_MTU)
  rp0->Connection_Handle = Connection_Handle;
  ...
  rp0->Offset = 0;
	...
	{
    rp0->Attr_Data_Length = MIN(Attr_Data_Length,USER_CUSTOM_ATT_MTU_SIZE);
    Osal_MemCpy((void *) rp0->Attr_Data,(const void *)(Attr_Data + rp0->Offset), rp0->Attr_Data_Length);
//    buffer_out[0] = 0x04;
		buffer_out[0] =	USER_CTRL_CODE_ATT_DATA;//USER_CTRL_CODE_ATT_DATA =0x10
    buffer_out[1] = 0xFF;
		/*evetn structure for this is 8 bytes for parameters and the two bytes opcode(010c) len handled by the application
		state machine*/ 
    buffer_out[2] = 2+2+2+2+2+2;/*used on main controller side to verify the packet */
    buffer_out[3] = 0x01;
    buffer_out[4] = 0x0c;
		buffer_out[5] = rp0->Attr_Data_Length&0xff;
		buffer_out[6] = rp0->Attr_Data_Length>>8&0xff;
		
    Attr_Data_Length -= rp0->Attr_Data_Length;
    if(Attr_Data_Length){ // If there are other data to be sent after the next HCI event.
      rp0->Offset |= 0x8000;
    }
		send_event((uint8_t*)buffer_out, (rp0->Attr_Data_Length+buffer_out[2])+ 3, 20); 
    rp0->Offset &= ~0x8000;
...
void aci_gatt_notification_event(uint16_t Connection_Handle,
                                 ...
                                 uint8_t Attribute_Value[])
{
  uint8_t buffer_out[CUSTOM_MAX_PAYLOAD_SIZE]={0x00};
...
/* Event len: 2 + 1 + rp0->Number_of_Handles * (sizeof(packed_Handle_Item_t)) */
/**
 ...
 * @param Connection_Handle Not used. Always 0.
