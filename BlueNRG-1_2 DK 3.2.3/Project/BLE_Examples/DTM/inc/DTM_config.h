...
#else
#define DTM_NUM_LINK            USER_ALWD_NUM_LINK// changed to 1link support bcz of lack of memory for 512 mtu //8 
#endif 
...
#else
#define MAX_ATT_MTU              USER_CUSTOM_ATT_MTU_SIZE//(220) 
#endif

/* Array size for the attribute value */
#define ATT_VALUE_ARRAY_SIZE    (1180)//(1180)//(1080) //1180
