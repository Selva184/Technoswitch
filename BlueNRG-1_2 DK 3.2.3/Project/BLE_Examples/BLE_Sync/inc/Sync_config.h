...
#define NUM_APP_GATT_SERVICES 2  /* Chat service and Sync service */
...
#elif SERVER
#define ATT_VALUE_ARRAY_SIZE    (44 + 160) //(GATT + GAP) = 44 + Chat  (TX (41) + RX (39) characteristics)   Services
#endif 
