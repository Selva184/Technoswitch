 ...
 * BlueNRG-1,2 Security peripheral \see P_main.c for documentation.
 *
 *@{
 */
...
int main(void) 
{
  ...
  */
  ...
  PRINTF("BlueNRG-1,2 BLE Security Peripheral Application (version: %s, security mode: %s; button: %d)\r\n", BLE_APPLICATION_VERSION_STRING,Security_Configuration,USER_BUTTON);
