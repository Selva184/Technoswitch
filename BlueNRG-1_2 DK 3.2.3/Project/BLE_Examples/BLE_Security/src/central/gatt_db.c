...
void enter_pass_key_SM(void)
{
  ...
  {
    PRINTF("**** Inserted Complete Pass Key : %06d\r\n", (int)pass_key);
...
{  
  if (masterContext.start_insert_passkey || masterContext.do_terminate_connection || masterContext.start_confirm_numeric_value ||
      SdkEvalComIOTxFifoNotEmpty() || SdkEvalComUARTBusy())
  {
