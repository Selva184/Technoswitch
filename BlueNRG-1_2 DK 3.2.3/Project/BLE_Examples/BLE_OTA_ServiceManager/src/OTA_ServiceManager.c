...
#define  ADV_INTERVAL_MAX_MS  300
...
{  
  ...
  aci_gap_set_discoverable(ADV_IND, (ADV_INTERVAL_MIN_MS*1000)/625,(ADV_INTERVAL_MAX_MS*1000)/625, RANDOM_ADDR, NO_WHITE_LIST_USE,
