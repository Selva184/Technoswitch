...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_OTA_ServiceManager\\MDK-ARM\\BlueNRG-1\\BLE_OTA_ServiceManager.uvprojx </tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_OTA_ServiceManager\\EWARM\\BlueNRG-1\\OTA_ServiceManager.eww </tt>
...
|     DL3    |  ON when OTA upgrade is ongoing  |  ON when OTA upgrade is ongoing  |  ON when OTA upgrade is ongoing  |  ON when OTA upgrade is ongoing  |  ON when OTA upgrade is ongoing  |  ON when OTA upgrade is ongoing  |
