                                            ...
                                            uint16_t Slave_Conn_Interval_Max)
{
  ...
  /* var_len_data input */
  {
    Osal_MemCpy((void *) &cp0->Local_Name, (const void *) Local_Name, Local_Name_Length*sizeof(uint8_t));
    index_input += Local_Name_Length*sizeof(uint8_t);
    {
      cp1->Service_Uuid_length = htob(Service_Uuid_length, 1);
    }
    index_input += 1;
    Osal_MemCpy((void *) &cp1->Service_Uuid_List, (const void *) Service_Uuid_List, Service_Uuid_length*sizeof(uint8_t));
                                   ...
                                   uint8_t AdvData[])
{
  ...
  /* var_len_data input */
  {
    Osal_MemCpy((void *) &cp0->AdvData, (const void *) AdvData, AdvDataLen*sizeof(uint8_t));
                                                        ...
                                                        Whitelist_Entry_t Whitelist_Entry[])
{
  ...
  /* var_len_data input */
  {
    for (int i = 0; i < Num_of_Whitelist_Entries; i++) {
      ...
      Osal_MemCpy((void *) &cp0->Whitelist_Entry[i].Peer_Address, (const void *) &Whitelist_Entry[i].Peer_Address, 6);
    }
                                      ...
                                      Whitelist_Entry_t Whitelist_Entry[])
{
  ...
  /* var_len_data input */
  {
    Osal_MemCpy((void *) &cp0->Adv_Data, (const void *) Adv_Data, Adv_Data_Length*sizeof(uint8_t));
    ...
    for (int i = 0; i < Num_of_Whitelist_Entries; i++) {
      ...
      Osal_MemCpy((void *) &cp1->Whitelist_Entry[i].Peer_Address, (const void *) &Whitelist_Entry[i].Peer_Address, 6);
    }
    index_input += Num_of_Whitelist_Entries*7;
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
                                                 ...
                                                 uint8_t Clear_Resolving_List)
{
  ...
  aci_gap_add_devices_to_resolving_list_cp1 *cp1 = (aci_gap_add_devices_to_resolving_list_cp1*)(cmd_buffer + 1 + Num_of_Resolving_list_Entries * (sizeof(packed_Whitelist_Identity_Entry_t)));
  tBleStatus status = 0;
  uint8_t index_input = 0;
  ...
  /* var_len_data input */
  {
    for (int i = 0; i < Num_of_Resolving_list_Entries; i++) {
      ...
      Osal_MemCpy((void *) &cp0->Whitelist_Identity_Entry[i].Peer_Identity_Address, (const void *) &Whitelist_Identity_Entry[i].Peer_Identity_Address, 6);
    }
