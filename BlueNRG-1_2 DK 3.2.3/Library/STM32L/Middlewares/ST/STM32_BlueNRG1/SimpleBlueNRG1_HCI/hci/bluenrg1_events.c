...
tBleStatus hci_le_direct_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  for (i = 0; i < rp0->Num_Reports; i++) {
    ...
    size += 1;
    Osal_MemCpy((void *) Direct_Advertising_Report[i].Address, (const void *) rp0->Direct_Advertising_Report[i].Address, 6);
    size += 6;
    Direct_Advertising_Report[i].Direct_Address_Type = rp0->Direct_Advertising_Report[i].Direct_Address_Type;
    size += 1;
    Osal_MemCpy((void *) Direct_Advertising_Report[i].Direct_Address, (const void *) rp0->Direct_Advertising_Report[i].Direct_Address, 6);
    size += 6;
